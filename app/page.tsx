    ...
    <>
      ...
      <section className="py-32 w-full  text-start bg-cover bg-bottom text-white mx-auto" style={{ backgroundImage: "url('/image/bg_contact2.jpg')" }}>
        <div className="max-w-[1440px] mx-auto  px-6 flex flex-col gap-4">
          ...
          <p className="max-w-xl  md:text-2xl leading-relaxed mb-8">
            문의 전화는 언제든 환영합니다. <br />
            부재중일 경우 문자로 남겨주시면 빠르게 회신드리겠습니다.
          </p>

          {/* 연락처 박스 */}
          <div className="inline-block bg-white/10 backdrop-blur-md border border-white/30 rounded-2xl px-4  md:px-8 py-6 hover:bg-white/20 transition-all duration-300">
      ...
      <section className="py-24 text-center bg-white">
        ...
        <div className="card-List grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 max-w-[1440px] py-10 mx-auto px-4">
          <Link href="/business?tab=underwater-welding" className="card-item border bg-black/10 rounded-xl overflow-hidden relative h-96 md:h-[440px] group">
          ...
          <div className="card-item border bg-black/10 rounded-xl overflow-hidden relative h-96 md:h-[440px] group">
            <Image src="/image/소나사운드.png" alt="소나 사우더 수중 곡직(특허)" fill className="object-cover" />
            <div className="absolute bottom-0 left-0 right-0 bg-black/70 p-4 text-center">
              <h4 className="text-white">소나 사우더 수중 곡직 (특허)</h4>
            </div>
          </div>
        </div>
      </section>
