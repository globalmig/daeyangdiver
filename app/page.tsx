...
export default function HeroVideo() {
  ...
  return (
    <>
      <section className="relative w-full h-[500px] lg:h-screen">
      ...
      <section className="py-24 w-full h-[500px] text-start bg-cover bg-bottom text-white mx-auto" style={{ backgroundImage: "url('/image/bg_contact.jpg')" }}>
        <div className="max-w-[1440px] mx-auto px-6 flex flex-col gap-4">
          <h2 className="text-3xl font-bold uppercase">견적문의</h2>
      ...
      <section className="py-24 text-center bg-white">
        ...
        <div className="card-List grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-2 max-w-[1440px] py-10 mx-auto px-4">
          <div className="card-item border bg-black/10 rounded-xl overflow-hidden relative h-96 group">
