  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <Image src="/image/선박수중작업.png" alt="선박 수중작업" fill className="object-cover" />
          {/* 오버레이 텍스트 영역 */}
          <div className="absolute bottom-10  left-6  md:left-20 text-white text-left border-l-4 pl-4 md:pl-10">
            {/* 제목 */}
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-semibold drop-shadow-lg text-shadow">선박 수중작업</h2>

            {/* 설명 */}
            <p className="text-base sm:text-lg md:text-4xl mt-1 opacity-90 text-shadow">선박 하부 점검·보수·절단·인양 등 모든 수중 작업</p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
